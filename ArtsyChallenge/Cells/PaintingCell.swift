...
class PaitingCell: UICollectionViewCell {
    ...
    private func addConstraints() {
        ...
        priceLabel.anchor(top: paintingImageView.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 10)
        authorLabel.anchor(top: priceLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 3)
        locationLabel.anchor(top: authorLabel.bottomAnchor, left: leftAnchor, right: rightAnchor, paddingTop: 3)
        agencyLabel.anchor(top: locationLabel.bottomAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, paddingTop: 5)
    }
